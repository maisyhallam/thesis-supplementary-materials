var jsPsychCanvasButtonOverlay = (function (jspsych) {
  'use strict';

  const info = {
      name: "canvas-button-overlay",
      parameters: {
  ...
  class CanvasButtonResponsePlugin {
      ...
      trial(display_element, trial) {
        ...
        if (trial.prompt !== null) {
          ...
          // create canvas
          html += '<div id="jspsych-canvas-button-response-stimulus"  position = "relative" height =' + trial.canvas_size[0] + ' width =' + trial.canvas_size[1] + '">' +
              '<canvas id="jspsych-canvas-stimulus" position = "absolute" height="' +
              trial.canvas_size[0] +
              '" width="' +
              trial.canvas_size[1] +
              '"></canvas>' +
