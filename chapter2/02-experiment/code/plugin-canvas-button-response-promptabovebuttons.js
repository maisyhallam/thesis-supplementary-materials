var jsPsychCanvasButtonResponsePromptAboveButtons = (function (jspsych) {
  'use strict';
   ...
   */
  class CanvasButtonResponsePromptAboveButtonsPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          for (var i = 0; i < trial.choices.length; i++) {
              ...
              html +=
                  '<div class="jspsych-canvas-button-response-button" style="display: inline; margin:' +
  ...
  CanvasButtonResponsePromptAboveButtonsPlugin.info = info;

  return CanvasButtonResponsePromptAboveButtonsPlugin;
