var jsPsychHtmlButtonResponse = (function (jspsych) {
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          // display stimulus
          var html = '<div id="jspsych-html-button-response-stimulus" style = "width: 50pc; text-align: center">' + trial.stimulus + "</div>";
          //display buttons
          var buttons = [];
          ...
          for (var i = 0; i < trial.choices.length; i++) {
              ...
              html +=
                  '<div class="jspsych-html-button-response-button" style="display: inline; margin:' +
