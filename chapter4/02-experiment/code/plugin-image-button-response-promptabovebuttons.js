var jsPsychImageButtonResponsePromptAboveButtons = (function (jspsych) {
   ...
   */
  class ImageButtonResponsePromptAboveButtonsPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          if (trial.render_on_canvas) {
              ...
              for (var i = 0; i < trial.choices.length; i++) {
                  ...
                  html +=
                      '<div class="jspsych-image-button-response-button" style="display: inline; margin:' +
            ...
            display_element.insertAdjacentHTML("beforeend", trial.prompt);
              ...
              display_element.appendChild(btngroup_div, canvas.nextElementSibling); // changed this from 'InsertBefore' to make sure buttons appear last
  ...
  ImageButtonResponsePromptAboveButtonsPlugin.info = info;

  return ImageButtonResponsePromptAboveButtonsPlugin;
